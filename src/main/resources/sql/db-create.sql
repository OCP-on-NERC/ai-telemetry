...
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS archived boolean;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS sessionId text;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS userKey bigint;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS objectTitle text;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS displayPage text;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS hubName text;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS hubId text;
ALTER TABLE Hub ADD COLUMN IF NOT EXISTS hubResource text UNIQUE;
...
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS created timestamp with time zone;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS archived boolean;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS sessionId text;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS userKey bigint;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS objectTitle text;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS displayPage text;
...
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS id text;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS ngsildTenant text;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS ngsildPath text;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS ngsildContext text;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS ngsildData jsonb;
ALTER TABLE Cluster ADD COLUMN IF NOT EXISTS aiNodesTotal integer;
...
ALTER TABLE AiNode ADD COLUMN IF NOT EXISTS hubId text;
ALTER TABLE AiNode ADD COLUMN IF NOT EXISTS hubResource text references Hub(hubResource);
ALTER TABLE AiNode ADD COLUMN IF NOT EXISTS clusterName text;
ALTER TABLE AiNode ADD COLUMN IF NOT EXISTS clusterResource text references Cluster(clusterResource);
ALTER TABLE AiNode ADD COLUMN IF NOT EXISTS nodeName text;
ALTER TABLE AiNode ADD COLUMN IF NOT EXISTS nodeResource text UNIQUE;
...
ALTER TABLE GpuDevice ADD COLUMN IF NOT EXISTS hubId text;
ALTER TABLE GpuDevice ADD COLUMN IF NOT EXISTS hubResource text references Hub(hubResource);
ALTER TABLE GpuDevice ADD COLUMN IF NOT EXISTS clusterName text;
ALTER TABLE GpuDevice ADD COLUMN IF NOT EXISTS clusterResource text references Cluster(clusterResource);
...
ALTER TABLE Project ADD COLUMN IF NOT EXISTS clusterResource text references Cluster(clusterResource);
...
ALTER TABLE BareMetalNode ADD COLUMN IF NOT EXISTS networkInfo jsonb;
