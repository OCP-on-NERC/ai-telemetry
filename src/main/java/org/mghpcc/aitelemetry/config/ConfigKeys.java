...
public class ConfigKeys extends ComputateConfigKeys {
	...
	public static JsonObject getPageContext(JsonObject config) {
        ...
        ctx.put(ENABLE_FEATURE_OBSERVE_BARE_METAL, config.getString(ENABLE_FEATURE_OBSERVE_BARE_METAL));
        ctx.put(ENABLE_FEATURE_OBSERVE_CLUSTER, config.getString(ENABLE_FEATURE_OBSERVE_CLUSTER));
        return ctx;
    }
    ...
    public static final String ENABLE_FEATURE_OBSERVE_BARE_METAL = "ENABLE_FEATURE_OBSERVE_BARE_METAL";
    public static final String ENABLE_FEATURE_OBSERVE_CLUSTER = "ENABLE_FEATURE_OBSERVE_CLUSTER";
