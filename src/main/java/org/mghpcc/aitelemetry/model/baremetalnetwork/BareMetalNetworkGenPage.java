...
public class BareMetalNetworkGenPage extends BareMetalNetworkGenPageGen<PageLayout> {
  ...
  protected void _pageResponse(Wrap<String> w) {
    if(searchListBareMetalNetwork_ != null)
      w.o(JsonObject.mapFrom(searchListBareMetalNetwork_.getResponse()).toString());
  }

  @Override
  protected void _stats(Wrap<SolrResponse.Stats> w) {
    w.o(searchListBareMetalNetwork_.getResponse().getStats());
  }

  @Override
  protected void _facetCounts(Wrap<SolrResponse.FacetCounts> w) {
    w.o(searchListBareMetalNetwork_.getResponse().getFacetCounts());
  }
  ...
  protected void _pagination(JsonObject pagination) {
    ...
    Long foundNum = searchListBareMetalNetwork_.getResponse().getResponse().getNumFound().longValue();
  ...
  protected void _query(JsonObject query) {
    ...
    Long num = searchListBareMetalNetwork_.getResponse().getResponse().getNumFound().longValue();
    String q = "*:*";
