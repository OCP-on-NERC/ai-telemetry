...
public class GpuDeviceGenPage extends GpuDeviceGenPageGen<PageLayout> {
  ...
  protected void _pageResponse(Wrap<String> w) {
    if(searchListGpuDevice_ != null)
      w.o(JsonObject.mapFrom(searchListGpuDevice_.getResponse()).toString());
  }

  @Override
  protected void _stats(Wrap<SolrResponse.Stats> w) {
    w.o(searchListGpuDevice_.getResponse().getStats());
  }

  @Override
  protected void _facetCounts(Wrap<SolrResponse.FacetCounts> w) {
    w.o(searchListGpuDevice_.getResponse().getFacetCounts());
  }
  ...
  protected void _pagination(JsonObject pagination) {
    ...
    Long foundNum = searchListGpuDevice_.getResponse().getResponse().getNumFound().longValue();
  ...
  protected void _query(JsonObject query) {
    ...
    Long num = searchListGpuDevice_.getResponse().getResponse().getNumFound().longValue();
    String q = "*:*";
